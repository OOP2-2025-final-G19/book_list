...
## 概要
今までに読んだ本を記録し、読書傾向を可視化するためのアプリケーションです。
書籍のタイトル、著者、評価、感想などを保存し、年別の読書量をグラフで確認することができます。また、学習管理機能として学生の成績管理も統合されています。
...
4.撮影およびデータの保存が正常に行われたかは、実行中のターミナルに表示されるログ（テスト用）を見て確認してください。